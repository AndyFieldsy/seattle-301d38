...
function displayPics(){
  ...
  // rando is no longer a global function, it is now declared using let, making it a local function. We would need to specify where to find it because being able to call it.
  console.log(viewed);
